...
TLM (Teaching-Learning Material) संदर्भ:
- 'Learning by doing' दृष्टिकोण को बढ़ावा दें।
- शून्य/कम लागत (low-cost/no-cost) वाले स्थानीय संसाधनों, अपशिष्ट पदार्थों (waste materials), गत्ते, पत्तियों आदि का उपयोग करें।
- इंटरैक्टिव गतिविधियाँ (फ्लैशकार्ड, वर्ड बिंगो, मैथोबोला, आदि) शामिल करें।
